...
import (
	...
	"github.com/MachDary/MachDary/net/http/httperror"
...
const (
	...
	HeaderCoreID       = consensus.NativeChainName + "-Core-ID"
...
func (c Client) userAgent() string {
	return fmt.Sprintf("%s; process=%s; buildtag=%s; blockchainID=%s",
		strings.Title(consensus.NativeChainName), c.Username, c.BuildTag, c.BlockchainID)
}
