...
type BlockHeader struct {
	...
	StateRoot             *Hash              `protobuf:"bytes,7,opt,name=state_root,json=stateRoot" json:"state_root,omitempty"`
...
type TxHeader struct {
	...
	MuxId          *Hash   `protobuf:"bytes,5,opt,name=mux_id,json=muxId" json:"mux_id,omitempty"`
	Data           *Hash   `protobuf:"bytes,6,opt,name=data" json:"data,omitempty"`
}
...
func (*TxLog) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }

func (m *TxLog) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type TxVerifyResult struct {
	...
	Logs       []*TxLog `protobuf:"bytes,2,rep,name=logs" json:"logs,omitempty"`
}
...
func (m *TxVerifyResult) GetLogs() []*TxLog {
	if m != nil {
		return m.Logs
	}
	return nil
...
type ContractDefinition struct {
	Creator *Program `protobuf:"bytes,1,opt,name=creator" json:"creator,omitempty"`
	Data    *Program `protobuf:"bytes,2,opt,name=data" json:"data,omitempty"`
}
...
func (*ContractDefinition) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }

func (m *ContractDefinition) GetCreator() *Program {
	if m != nil {
		return m.Creator
	}
	return nil
...
func (m *ContractDefinition) GetData() *Program {
	if m != nil {
		return m.Data
	}
	return nil
...
type Creation struct {
	...
	WitnessDestination *ValueDestination `protobuf:"bytes,2,opt,name=witness_destination,json=witnessDestination" json:"witness_destination,omitempty"`
	From               *Program          `protobuf:"bytes,3,opt,name=from" json:"from,omitempty"`
	Input              *Program          `protobuf:"bytes,4,opt,name=input" json:"input,omitempty"`
	WitnessArguments   [][]byte          `protobuf:"bytes,5,rep,name=witness_arguments,json=witnessArguments,proto3" json:"witness_arguments,omitempty"`
	Ordinal            uint64            `protobuf:"varint,6,opt,name=ordinal" json:"ordinal,omitempty"`
}
...
func (*Creation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }

func (m *Creation) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *Creation) GetWitnessDestination() *ValueDestination {
	if m != nil {
		return m.WitnessDestination
	}
	return nil
...
func (m *Creation) GetFrom() *Program {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *Creation) GetInput() *Program {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *Creation) GetWitnessArguments() [][]byte {
	if m != nil {
		return m.WitnessArguments
	}
	return nil
...
func (m *Creation) GetOrdinal() uint64 {
	if m != nil {
		return m.Ordinal
	}
	return 0
...
type Call struct {
	...
	WitnessDestination *ValueDestination `protobuf:"bytes,2,opt,name=witness_destination,json=witnessDestination" json:"witness_destination,omitempty"`
	From               *Program          `protobuf:"bytes,3,opt,name=from" json:"from,omitempty"`
	To                 *Program          `protobuf:"bytes,4,opt,name=to" json:"to,omitempty"`
	Input              *Program          `protobuf:"bytes,5,opt,name=input" json:"input,omitempty"`
...
func (*Call) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }

func (m *Call) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *Call) GetWitnessDestination() *ValueDestination {
	if m != nil {
		return m.WitnessDestination
	}
	return nil
...
func (m *Call) GetWitnessArguments() [][]byte {
	if m != nil {
		return m.WitnessArguments
	}
	return nil
...
func (*Contract) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }

func (m *Contract) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *Contract) GetWitnessDestination() *ValueDestination {
	if m != nil {
		return m.WitnessDestination
	}
	return nil
...
func (m *Contract) GetFrom() *Program {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *Contract) GetInput() *Program {
	if m != nil {
		return m.Input
	}
	return nil
...
func (m *Contract) GetWitnessArguments() [][]byte {
	if m != nil {
		return m.WitnessArguments
	}
	return nil
...
func (m *Contract) GetOrdinal() uint64 {
	if m != nil {
		return m.Ordinal
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*TxLog)(nil), "bc.TxLog")
	...
	proto.RegisterType((*ContractDefinition)(nil), "bc.ContractDefinition")
	proto.RegisterType((*Creation)(nil), "bc.Creation")
	proto.RegisterType((*Call)(nil), "bc.Call")
	proto.RegisterType((*Contract)(nil), "bc.Contract")
}
...
var fileDescriptor0 = []byte{
	...
	,
}
