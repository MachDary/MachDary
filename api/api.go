...
import (
	...
	"github.com/MachDary/MachDary/core/accesstoken"
	cfg "github.com/MachDary/MachDary/config"
	"github.com/MachDary/MachDary/generated/dashboard"
	"github.com/MachDary/MachDary/basis/errors"
	"github.com/MachDary/MachDary/mining/cpuminer"
	"github.com/MachDary/MachDary/mining/miningpool"
	"github.com/MachDary/MachDary/net/http/authn"
	"github.com/MachDary/MachDary/net/http/gzip"
	"github.com/MachDary/MachDary/net/http/httpjson"
	"github.com/MachDary/MachDary/net/http/static"
	"github.com/MachDary/MachDary/net/netsync"
	"github.com/MachDary/MachDary/protocol"
	"github.com/MachDary/MachDary/core/wallet"
)
...
func NewAPI(sync *netsync.SyncManager, wallet *wallet.Wallet, cpuMiner *cpuminer.CPUMiner, miningPool *miningpool.MiningPool, chain *protocol.Chain, config *cfg.Config, token *accesstoken.CredentialStore) *API {
	api := &API{
		sync:         sync,
		wallet:       wallet,
		chain:        chain,
...
func (a *API) buildHandler() {
	...
	m.Handle("/call-contract", jsonHandler(a.callContract))
	m.Handle("/balance-of", jsonHandler(a.balanceOf))
