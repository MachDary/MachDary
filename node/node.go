...
import (
	...
	"github.com/MachDary/MachDary/basis/env"
	...
	w "github.com/MachDary/MachDary/core/wallet"
)
...
func NewNode(config *cfg.Config) *Node {
	...
	if profileHost != "" {
		// Profiling server programs.see (https://blog.golang.org/profiling-go-programs)
...
func newPoolTxListener(txPool *protocol.TxPool, syncManager *netsync.SyncManager, wallet *w.Wallet) {
	...
	for {
		...
		default:
			log.Warn("got unknown message type from the txPool channel")
		}
	}
}
...
func (n *Node) initAndstartApiServer() {
	n.api = api.NewAPI(n.syncManager, n.wallet, n.cpuMiner, n.miningPool, n.chain, n.config, n.accessTokens)
